        ...
        () => {
            ...
            function initSignature(progressThreshold, useNormalST = false) {
                ...
                const paths = Array.from(
                    sigRef.current.querySelectorAll('path[data-stroke]')
                );
            ...
            <div ref={trackRef} className="ap-track">
                ...
                <div className="ap-panel ap-panel--bio">
                    ...
                    <div className="ap-bio-body">
                        <Copy animateOnScroll={true}>
                            <p className="lg">
                                I&apos;m Supratik Sahis, a photographer
                                exploring the quiet psychology of everyday life.
                                For the past four years, I&apos;ve been
                                documenting the streets &mdash; capturing
                                unfiltered moments and intimate close-up
                                portraits of strangers whose stories exist
                                beyond the frame.
                            </p>
                            <p className="lg">
                                Based in the electric chaos of Kolkata, I work
                                across portrait, documentary, and fine-art
                                photography. Every frame is a negotiation
                                between what is and what could be. I don&apos;t
                                take photographs &mdash; I make them.
                            </p>
                        </Copy>
                    </div>
                </div>
                ...
                <div className="ap-panel ap-panel--data">
                    ...
                    <div className="ap-quote-block">
                        <Copy animateOnScroll={true}>
                            <p className="lg">
                                &quot;Light is not what I photograph.
                                <br />
                                Light is how I think.
                                <br />
                                Every shadow is a decision.&quot;
                            </p>
                        </Copy>
                        <span className="ap-quote-attr">
                            &mdash; Supratik Sahis
                        </span>
                    </div>
                </div>
                <div className="ap-panel ap-panel--sig">
                    <div className="ap-sig-wrap">
                        ...
                        >
                            <path
                                data-stroke="1"
                                d="M14 36 C14 24, 32 18, 42 28 C52 38, 44 50, 28 53 C12 56, 8 68, 18 76 C28 84, 48 80, 52 68"
                                stroke="currentColor"
                                strokeWidth="2.2"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                            ...
                            <path
                                data-stroke="1"
                                d="M62 44 C60 60, 62 72, 72 72 C82 72, 86 60, 84 46 L84 72"
                                stroke="currentColor"
                                strokeWidth="2.2"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                            ...
                            <path
                                data-stroke="1"
                                d="M96 44 L94 88 M94 44 C102 34, 118 34, 120 50 C122 64, 112 72, 100 66"
                                stroke="currentColor"
                                strokeWidth="2.2"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                            ...
                            <path
                                data-stroke="1"
                                d="M130 56 L130 72 M130 56 C136 46, 148 42, 152 52"
                                stroke="currentColor"
                                strokeWidth="2.2"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                            ...
                            <path
                                data-stroke="1"
                                d="M160 50 C160 38, 176 34, 180 46 C182 56, 174 72, 162 70 C170 70, 180 68, 182 72"
                                stroke="currentColor"
                                strokeWidth="2.2"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                            ...
                            <path
                                data-stroke="1"
                                d="M192 30 L192 72 M184 52 L202 52"
                                stroke="currentColor"
                                strokeWidth="2.2"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                            ...
                            <path
                                data-stroke="1"
                                d="M222 36 L222 72 M236 54 L222 62 M226 58 L240 72"
                                stroke="currentColor"
                                strokeWidth="2.2"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                            ...
                            <path
                                data-stroke="1"
                                d="M10 90 C70 100, 180 86, 248 94"
                                stroke="currentColor"
                                strokeWidth="1.2"
                                strokeLinecap="round"
                                opacity="0.5"
